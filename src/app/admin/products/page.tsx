            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Manage your digital products for PPV and Digiworldadda
                </p>
              </div>
            </div>
          </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Select which platform you want to create a product for.
                  </DialogDescription>
                </DialogHeader>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
              ...
              <CardDescription className="text-sm">
                Manage your digital products for the selected collection
              </CardDescription>
            </div>
            <div className="flex items-center gap-2">
              <Button variant={company === 'ppv' ? 'default' : 'outline'} size="sm" onClick={() => setCompany('ppv')}>
                PPV
              </Button>
              <Button variant={company === 'digiworldadda' ? 'default' : 'outline'} size="sm" onClick={() => setCompany('digiworldadda')}>
                Digiworldadda
              </Button>
            </div>
          </div>
